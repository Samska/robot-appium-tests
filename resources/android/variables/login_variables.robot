...
${ERROR_MSG}            //android.view.ViewGroup[@content-desc="generic-error-message"]/android.widget.TextView
${LOGOUT_YES}           android:id/button1
${LOGOUT_OK}            android:id/button1
${LOGOUT_MSG}           android:id/alertTitle